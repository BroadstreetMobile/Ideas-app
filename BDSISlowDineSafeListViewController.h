//
//  BDSISlowDineSafeListViewController.h
//  Ideas
//
...
@interface BDSISlowDineSafeListViewController : UITableViewController <UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate>
